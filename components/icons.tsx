...
export const BrainIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="M12 15a2.5 2.5 0 0 1 2.5 2.5v0A2.5 2.5 0 0 1 12 20h0a2.5 2.5 0 0 1-2.5-2.5v0A2.5 2.5 0 0 1 12 15z" />
        ...
        <path d="m12 4.5 2.5 2.5" />
        <path d="M12 15a2.5 2.5 0 0 0-2.5 2.5" />
        <path d="M12 15a2.5 2.5 0 0 1 2.5 2.5" />
        <path d="M7 12.5a2.5 2.5 0 0 0 2.5 2.5" />
        <path d="M14.5 12.5a2.5 2.5 0 0 1-2.5-2.5" />
        <path d="M7 4.5a2.5 2.5 0 0 1 2.5 2.5" />
...
export const SparkleIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M12 2L9.5 9.5 2 12l7.5 2.5L12 22l2.5-7.5L22 12l-7.5-2.5L12 2zM5 5l1.5 1.5M17.5 17.5L19 19M19 5l-1.5 1.5M5 19l1.5-1.5"/>
    </svg>
);
